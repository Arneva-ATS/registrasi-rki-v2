                ...
                <div id="wizard_container">
                    ...
                    <form id="wrapped" enctype="multipart/form-data">
                        ...
                        <div id="middle-wizard">
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>2 of 12</strong>Data Koperasi
                                </h3>
                                <div class="row">
                            ...
                            <div class="step">
                                <h3 class="main_question mb-4">
                                    <strong>3 of 12</strong>Alamat Koperasi
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>4 of 12</strong>Nama Pengurus
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>5 of 12</strong>Pengawas Koperasi
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>6 of 12</strong>Akta Pendirian
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>7 of 12</strong>SK. Kemenkumham
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>8 of 12</strong> Surat Pengesahan Koperasi dari Kemenkop & UKM
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>9 of 12</strong> Akta Perubahan
                                </h3>
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>10 of 12</strong>SIUP/NIB
                                </h3>
                            ...
                            <div class="step">
                                <h3 class="main_question">
                                    <strong>11 of 12</strong>Surat Keterangan Domisili Usaha
                                </h3>
                            ...
                            <div class="submit step">
                                <h3 class="main_question">
                                    <strong>12 of 12</strong>No Sertifikat Koperasi
                                </h3>
                                <div class="form-group">
                        ...
                        <div id="bottom-wizard">
                            ...
                            <button type="button" name="forward" class="forward" hidden>
                                Next
                            </button>
...
@push('js')
    ...
    <script>
        ...
        document.getElementById('nis').addEventListener('change', function() {
            ...
            if (nis) {
                fetch(`/api/koperasi/verifikasi-nis/${nis}`)
